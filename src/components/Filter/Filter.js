  ...
  return(
    <div data-uk-filter="target: .js-filter">
      <ul className={classes.filterList}>
        ...
        <li className={classes.attr} data-uk-filter-control="[data-tags*='attractions']"><button type="button">Attractions</button></li>
      ...
      <ul className={["js-filter", classes.filterContent].join(' ')}>
        ...
        <li data-tags="all attractions">Foley Model Train Exhibit</li>
        <li data-tags="all services">Foley Police Department</li>
        <li data-tags="all services">Foley Public Library</li>
        <li data-tags="all attractions">Foley Railroad Museum</li>
        ...
        <li data-tags="all attractions">Holmes Medical Museum</li>
