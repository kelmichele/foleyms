        ...
        <li><NavLink className={classes.MobTitle} to="#">Community Links</NavLink>
          <div className={["uk-navbar-dropdown", classes.custDrop, classes.LgDrop].join(' ')}>
            <ul className={classes.dropMenu}>
              ...
              <NavLink to="/resident-consumer-survey" className={[classes.NavigationItems, classes.dropLink, classes.alt].join(' ')}>Resident &amp; Consumer Survey</NavLink>
                {/* <a href={residentSurvey} target="_blank" className={[classes.NavigationItems, classes.dropLink, classes.alt].join(' ')} rel="noopener noreferrer"></a> */}
              </li>
